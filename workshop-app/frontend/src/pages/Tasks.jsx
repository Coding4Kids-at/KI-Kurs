    ...
    <div className={`rounded-xl border p-4 transition-all ${done ? 'border-green-200 bg-green-50 dark:border-green-800 dark:bg-green-900/20' : 'border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-800'}`}>
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="text-gray-500 dark:text-gray-400 text-xs mt-0.5 whitespace-pre-line break-words">{task.description}</div>
          ...
          {task.hint && (
            <div className="mt-2">
              ...
              {openHints[task.id] && (
                <div className="mt-1.5 text-xs text-amber-700 dark:text-amber-300 bg-amber-50 dark:bg-amber-900/25 border border-amber-100 dark:border-amber-800 rounded-lg px-3 py-2 whitespace-pre-line break-words">
                  {task.hint}
                </div>
              )}
            </div>
